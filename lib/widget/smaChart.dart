...
class WidgetSmaChart extends StatefulWidget {
  const WidgetSmaChart({Key? key}) : super(key: key);

  @override
  _WidgetSmaChartState createState() => _WidgetSmaChartState();
}

class _WidgetSmaChartState extends State<WidgetSmaChart> {
