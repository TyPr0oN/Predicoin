...
class WidgetMacdChart extends StatefulWidget {
  const WidgetMacdChart({Key? key}) : super(key: key);

  @override
  _WidgetMacdChartState createState() => _WidgetMacdChartState();
}

class _WidgetMacdChartState extends State<WidgetMacdChart> {
      ...
      body: Center(
        ...
        children: [
          SfCartesianChart(
              ...
              primaryXAxis:
                  DateTimeAxis(labelStyle: TextStyle(color: Colors.white)),
              primaryYAxis:
