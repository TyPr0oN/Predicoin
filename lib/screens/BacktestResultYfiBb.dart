...
class BacktestResultYfiBbPage extends StatefulWidget {
  const BacktestResultYfiBbPage({Key? key, required this.investresultBb})
      : super(key: key);
...
class _BacktestResultPageState extends State<BacktestResultYfiBbPage> {
  File? backtestYfi;
  ...
  Future<String> postInvest(investValue) async {
    try {
      postInvestResult = await Provider.of<BacktestYfi>(context, listen: false)
          .sendInvestYfiBb(investment_value: investValue);
      yfiinfo =
          await Provider.of<CoinYfi>(context, listen: false).fetchRequest();
      print('hellotry from bb yfi');
                              ...
                              children: [
                                InteractiveViewer(
                                  ...
                                  child: new Image.network(
                                    'http://10.0.2.2:8000/yfi_bb_plot',
                                    // width: 400,
                                    // height: 400,
                                    fit: BoxFit.cover,
                                  ),
