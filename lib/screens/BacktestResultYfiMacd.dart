...
class BacktestResultYfiMacdPage extends StatefulWidget {
  const BacktestResultYfiMacdPage({Key? key, required this.investresultMacd})
      : super(key: key);
...
class _BacktestResultPageState extends State<BacktestResultYfiMacdPage> {
  File? backtestYfi;
  ...
  Future<String> postInvest(investValue) async {
    try {
      postInvestResult = await Provider.of<BacktestYfi>(context, listen: false)
          .sendInvestYfiMacd(investment_value: investValue);
      yfiinfo =
          await Provider.of<CoinYfi>(context, listen: false).fetchRequest();
      print('hellotry from macd yfi');
                              ...
                              children: [
                                InteractiveViewer(
                                  ...
                                  child: new Image.network(
                                    'http://10.0.2.2:8000/yfi_macd_plot',
                                    // width: 400,
                                    // height: 400,
                                    fit: BoxFit.cover,
                                  ),
