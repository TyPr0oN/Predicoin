...
class BacktestResultSolPage extends StatefulWidget {
  const BacktestResultSolPage({Key? key, required this.investresult})
      : super(key: key);
...
class _BacktestResultPageState extends State<BacktestResultSolPage> {
  File? backtestSol;
  ...
  Future<String> postInvest(investValue) async {
    try {
      postInvestResult = await Provider.of<BacktestSol>(context, listen: false)
          .sendInvestSolSma(investment_value: investValue);
      solInfo =
                              ...
                              children: [
                                InteractiveViewer(
                                  ...
                                  child: new Image.network(
                                    'http://10.0.2.2:8000/sol_sma_plot',
                                    // width: 400,
                                    // height: 400,
                                    fit: BoxFit.cover,
                                  ),
